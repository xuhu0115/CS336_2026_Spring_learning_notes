# CS336 Lecture 1: 课程概览与分词（Tokenization）
...
5. [分词（Tokenization）](#5-分词tokenization)
6. [BPE 分词算法详解](#6-bpe-分词算法详解)
7. [总结与展望](#7-总结与展望)
...
### 5.1 什么是 Tokenization？

**核心问题**：模型操作的"原子"是什么？

**形式化定义**：Tokenizer 是一个在**原始输入（字节）** 和**整数序列（token）** 之间互相转换的模块。
...
### 5.3 以 GPT-5 (o200k_base) Tokenizer 为例
...
>
> 相关尝试：ByT5 [[byt5_2021]](https://arxiv.org/abs/2105.13626), MegaByte [[megabyte_2023]](https://arxiv.org/abs/2305.07185), BLT [[blt_2024]](https://arxiv.org/abs/2406.12350), TFree [[tfree_2024]](https://arxiv.org/abs/2406.12351), HNet [[hnet_2025]](https://arxiv.org/abs/2504.00690)
>
> 但这些方法尚未在前沿模型中得到大规模验证，所以目前我们仍然需要学习 tokenization。

### 5.5 四种 Tokenizer 方案的对比

#### 5.5.1 Character-Level Tokenizer（字符级）
...
#### 5.5.2 Byte-Level Tokenizer（字节级）
...
### 6.6 即使未来淘汰 Tokenization，什么原则不会变？
